...
$log = "INSERT into cs_log(fileid,date_time,browser,device,user_name,ip,country,referrer,lattitude,longitude) VALUES('".$id."','".$date."','".$browser."','".$device."','".$userid."','".$ip."','".$country."','".$_SERVER['HTTP_REFERER']."','".$lat."','".$long."')";
