...
$date2 = date("Y-m-d");
$min = date("Y-m-d", strtotime($packagedata['pkg_created_date']));
...
if(isset($_GET['sdate'])){
	$day = strtotime($_GET['sdate']);
} else{
	$day = strtotime($packagedata['pkg_created_date']);
}

$now = time();
$your_date = strtotime($packagedata['pkg_created_date']);
...
<body>
                                        ...
                                        <div class="row chart_filter">
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="evpageqty filter-date-field form-group">
                                                    ...
                                                    <input class="form-control" id="edate" type="date" name="edate" min="<?php echo $min;?>" max="<?php echo date("Y-m-d");?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-12 col-sm-12">
                                                <div class="evpageqty filter-date-field filter_view_btn form-group">
                                                    ...
                                                    <!-- <a class="btn map_view" href="viewMaps.php?package_id=<?php echo $_GET['id'];?>">Map View <i class="fa fa-eye" aria-hidden="true"></i></a> -->
                                                </div>
                                            </div>
                                        </div>
                                        <div id="chart">                                              
    ...
    <script>
        ...
        $('#select-chart').on('change', function(){
          ...
          $.ajax({
            type: "POST",
            url: "filter-package-stats.php?id="+id,
            data:{
              chart:chart,
              sdate:sdate,
              edate:edate
