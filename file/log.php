...
$log = "INSERT into cs_log(fileid,date_time,browser,device,user_name,ip,country,referrer,lattitude,longitude) VALUES('".$id."','".$date."','".$browser."','".$device."','".$userid."','".$ip."','".$country."','".$referer."','".$lat."','".$long."')";
