...
//        console.info(_t, _t.children(argfind).length, argfind);
    ...
    $.fn.zoomvideoplayer = function(o) {
        ...
        var defaults = {
            ...
            , responsive_ratio: 'off' // -- enter a number 0.5 / 1.2 to describe the width/height ratio
            , settings_rtmpServer: ''
...
//                    console.info(_global_youtubeIframeAPIReady);
                    if(_global_youtubeIframeAPIReady){
                        init_readyControls();
                    }else{
...
//                    console.info(can_play_mp4(), !is_firefox(), o.settings_rtmpServer,o.settings_rtmpServer!='' && (is_safari() || is_ios()))
                    if(can_play_mp4() && !is_firefox() && (o.settings_rtmpServer=='' || (o.settings_rtmpServer!='' && (is_safari() || is_ios() || is_android() )))){
                        videolayer = '<video class="the-media" preload';
                        videolayer+='>';
...
//                    _theMediaCon.append(videolayer);
                    ...
                    player = new YT.Player('the-media-'+cid, {
                        height: '100%',
                        width: '100%',
