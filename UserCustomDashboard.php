...
?>
<html lang="en">
<title>Create Dashboard - ShareIO</title>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="main_content hidden">
                            ...
                            <form method="post" id="uploadFormcontent" name="uploadFormcontent" action="include/adduserdashboard.php">
                                        ...
                                        <div class="upload-contents">
                                            <div class="upload_content_form upload_content_form1 items">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="dashboard_name" name="dashboard_name" class="form-control">
                                                ...
                                                <div class="form-group color_list">
                                                    ...
                                                    <div id="colorSelector3" style="background: #4e5f78;"></div>
                                                </div>
                                                <?php
                                                $dashboard_data = '[
                                                                        {
                                                                        ...
                                                                        "w": 12,
                                                                        "h": 3,
                                                                        "content": "  \n<a class=\"remove-stack\" onclick=\"grid.removeWidget(this.parentNode.parentNode)\"><i class=\"fa fa-times\" aria-hidden=\"true\"></i></a><a class=\"changefile\" style=\"background-color: #5c80a8;\"><p id=\"title\" style=\"color: #ffffff;\">Sample Content</p></a>"
                                                                        }
                                                                    ]';
                                                ?>
                                            </div>
