...
$id = $_GET['id'];
$package = "SELECT * FROM `package_list` where pkg_id = '".$id."'";
$results = mysqli_query($con,$package);
$packagedata = mysqli_fetch_array($results);
$date1 = $packagedata['pkg_created_date'];
$date2 = date("Y-m-d");
$ts1 = strtotime($date1);
$ts2 = strtotime($date2);
$year1 = date('Y', $ts1);
...
if(isset($_POST['sdate']) && !empty($_POST['sdate'])){
  ...
  $your_date = $day = strtotime($packagedata['pkg_created_date']);
}
...
if($_POST['chart'] == 'share'){
    while($i <= $totalDays){
        ...
        $view = "SELECT COUNT(log_id) as views from cs_log WHERE package_id = '".$id."' and DATE_FORMAT( date_time, '%Y-%M-%d' ) = '".$date."'";
        ...
        $sale = "SELECT COUNT(transfer_amount) as amounts from payments WHERE package_id = '".$id."' and DATE_FORMAT( p_date, '%Y-%M-%d' ) = '".$date."'";
...
<?php
    ...
    while($i <= $totalDays){
        ...
        //Content view according to country
        $country = "SELECT COUNT(log_id) as views, country from cs_log WHERE package_id = '".$id."' and DATE_FORMAT( date_time, '%Y-%M-%d' ) = '".$date."' and country != '' GROUP BY country";
        ...
        } else if(mysqli_num_rows($country_results) > 0){
            $view_arr = array();
            $country_arr = array();
            while($country_filedata = mysqli_fetch_array($country_results)){
                $view_arr[$country_filedata['country']] = $country_filedata['views'];
...
<?php
    ...
    while($i <= $totalDays){
        ...
        $city = "SELECT ip from cs_log WHERE package_id = '".$id."' and DATE_FORMAT( date_time, '%Y-%M-%d' ) = '".$date."'";
...
<?php
    ...
    while($i <= $totalDays){
        ...
        $device = "SELECT COUNT(log_id) as views, device from cs_log WHERE package_id = '".$id."' and DATE_FORMAT( date_time, '%Y-%M-%d' ) = '".$date."' and device != '' GROUP BY device";
...
<?php
    ...
    while($i <= $totalDays){
        ...
        $facebook = "SELECT COUNT(log_id) as views from cs_log WHERE package_id = '".$id."' and referrer LIKE '%facebook%' and DATE_FORMAT( date_time, '%Y-%M-%d' ) = '".$date."'";
        ...
        $twitter = "SELECT COUNT(log_id) as views from cs_log WHERE package_id = '".$id."' and referrer LIKE '%t.co%' and DATE_FORMAT( date_time, '%Y-%M-%d' ) = '".$date."'";
        ...
        $linkedin = "SELECT COUNT(log_id) as views from cs_log WHERE package_id = '".$id."' and referrer LIKE '%lnkd%' and DATE_FORMAT( date_time, '%Y-%M-%d' ) = '".$date."'";
        ...
        $google = "SELECT COUNT(log_id) as views from cs_log WHERE package_id = '".$id."' and referrer LIKE '%google%' and DATE_FORMAT( date_time, '%Y-%M-%d' ) = '".$date."'";
...
<?php
    ...
    while($i <= $totalDays){
        ...
        $impression = "SELECT COUNT(imp_id) as imp from file_impression WHERE package_id = '".$id."' and DATE_FORMAT( imp_date, '%Y-%M-%d' ) = '".$date."'";
        $impression_results = mysqli_query($con,$impression);
        if(mysqli_num_rows($impression_results) > 0){
...
<?php
    ...
    $users_data = array();
    $org = mysqli_query($con,"SELECT DISTINCT ip, lattitude , longitude , user_name, package_id FROM `cs_log` where package_id = '".$id."'");
...
<?php
    ...
    $users_data = array();
    $org = mysqli_query($con,"SELECT DISTINCT ip, lattitude , longitude FROM `cs_log` where package_id = '".$id."' AND lattitude != ''");
    while($users_da = mysqli_fetch_array($org)){
        if($users_da['lattitude'] != ''){
            $data['lat'] = $users_da['lattitude'];
            $data['lng'] = $users_da['longitude'];
